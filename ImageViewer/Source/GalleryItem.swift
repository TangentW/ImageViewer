...
public typealias FetchVideoURLBlock = (@escaping VideoURLCompletion) -> Void
...
public enum GalleryItem {
    ...
    case video(fetchPreviewImageBlock: FetchImageBlock, fetchVideoURLBlock: FetchVideoURLBlock)
