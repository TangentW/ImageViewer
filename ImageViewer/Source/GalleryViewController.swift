...
open class GalleryViewController: UIPageViewController, ItemControllerDelegate {
    ...
    public init(startIndex: Int, itemsDataSource: GalleryItemsDataSource, itemsDelegate: GalleryItemsDelegate? = nil, displacedViewsDataSource: GalleryDisplacedViewsDataSource? = nil, configuration: GalleryConfiguration = []) {
        ...
        for item in configuration {
            ...
            case .blurPresentAnimationStyle(let style):         overlayView.blurPresentAnimationStyle = style
            case .colorPresentAnimationStyle(let style):        overlayView.colorPresentAnimationStyle = style
            case .blurDismissAnimationStyle(let style):         overlayView.blurDismissAnimationStyle = style
            case .colorDismissAnimationStyle(let style):        overlayView.colorDismissAnimationStyle = style
